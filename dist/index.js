...
var j=require('@stdlib/assert-is-wasm-memory/dist'),m=require('@stdlib/utils-define-nonenumerable-read-only-property/dist'),z=require('@stdlib/utils-inherit/dist'),w=require('@stdlib/wasm-module-wrapper/dist'),D=require('@stdlib/error-tools-fmtprodmsg/dist'),L=x();function o(e){if(!(this instanceof o))return new o(e);if(!j(e))throw new TypeError(D('26vH0',e));return w.call(this,L,e,{env:{memory:e}}),this}z(o,w);m(o.prototype,"main",function(r,n,u,i,a,t){return this._instance.exports.c_saxpy(r,n,u,i,a,t),a});m(o.prototype,"ndarray",function(r,n,u,i,a,t,v,c){return this._instance.exports.c_saxpy_ndarray(r,n,u,i,a,t,v,c),t});M.exports=o
